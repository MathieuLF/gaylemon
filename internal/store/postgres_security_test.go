...
func TestSeasonArchiveProofRequiresImmutableBackupAndReceipt(t *testing.T) {
	...
	for name, raw := range map[string]string{
		"mauvaise saison":     `{"seasonId":"autre","slug":"saison-2026","immutableBackup":"/srv/storage/steam/servers/palworld/backups/seasons/saison-2026/final-aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa.tar.zst","backupSha256":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","receipt":"/var/lib/gaylemon-agent/season-receipts/saison-2026-aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa.json","receiptSha256":"bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb","queueDepth":0,"palworldPid":"4242","palworldRestarts":"0"}`,
		"sauvegarde mutable":  `{"seasonId":"season-2026","slug":"saison-2026","immutableBackup":"/tmp/final-aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa.tar.zst","backupSha256":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","receipt":"/var/lib/gaylemon-agent/season-receipts/saison-2026-aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa.json","receiptSha256":"bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb","queueDepth":0,"palworldPid":"4242","palworldRestarts":"0"}`,
