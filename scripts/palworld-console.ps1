...
function Show-MainMenu {
    while ($true) {
        ...
        Write-MenuItem "17" (Get-Icon "Api") "Statut du tunnel API local" "bot Discord" "Green"
        Write-MenuItem "18" (Get-Icon "Api") "Démarrer le tunnel API local" "" "Green"
        Write-MenuItem "19" (Get-Icon "Api") "Arrêter le tunnel API local" "" "Yellow"
        Write-MenuItem "20" (Get-Icon "Windows") "Démarrer les services locaux Windows" "tunnel, microsite, métriques" "Green"
